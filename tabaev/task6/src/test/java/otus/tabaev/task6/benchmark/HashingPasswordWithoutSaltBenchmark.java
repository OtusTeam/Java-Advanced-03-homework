...
public class HashingPasswordWithoutSaltBenchmark extends AbstractBenchmark {
    ...
    public void setUp() throws NoSuchAlgorithmException {
        ...
        sha256Digest.update(saltBytes);
        sha512Digest.update(saltBytes);

    }

    @Benchmark
    public void md5HashingPasswordWithoutSaltBenchmark(Blackhole blackhole) {
        blackhole.consume(md5Digest.digest(passwordExample.getBytes()));
    }

    @Benchmark
    public void sha256HashingPasswordWithoutSaltBenchmark(Blackhole blackhole) {
        blackhole.consume(sha256Digest.digest(passwordExample.getBytes()));
    }

    @Benchmark
    public void sha512HashingPasswordWithoutSaltBenchmark(Blackhole blackhole) {
