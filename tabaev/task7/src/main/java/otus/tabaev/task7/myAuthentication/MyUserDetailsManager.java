...
import otus.tabaev.task7.cache.MyCache;
import otus.tabaev.task7.model.MyUser;
import otus.tabaev.task7.repository.MyUserRepository;
...
public class MyUserDetailsManager implements UserDetailsManager {
    ...
    public void deleteUser(String username) {
        myUserRepository.deleteByLogin(username);
    }
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return new otus.tabaev.task7.myAuthentication.MyUserDetails(myUser);
    }
}
