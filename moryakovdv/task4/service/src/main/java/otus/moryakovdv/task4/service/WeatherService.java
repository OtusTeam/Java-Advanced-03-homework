...
/**
 * Преобразовывает данные от модуля Provider в WeatherConditions и передает в
 * CORE для записи в хранилище
 */
public class WeatherService {
	 ...
	 * 
	 * @param conditions - принятый от модуля Provider идентификатор погодных
	 *                   условий
	 * @return - идентификатор сохраненной сущности
	 */
